 ...
 * 2    
 >This directory is used to store the experimental results of the LncTarD dataset
 * 3
 >This directory is used to store the experimental results of the NPInter dataset
