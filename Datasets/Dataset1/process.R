...
lg_path_name="/mnt/5468d/gaomeihong/LncRNA3/GAE_LGA/Datasets/Dataset3/lnc_pcg_net.txt"
LG=read.table(file = lg_path_name,
					sep = "\t", header = TRUE, 
					row.names = 1, stringsAsFactors = FALSE)
					
lnc_path_name="/mnt/5468d/gaomeihong/LncRNA3/GAE_LGA/Datasets/Dataset3/lnc_name.txt"
lnc_names=rownames(read.table(file = lnc_path_name,
					sep = "\t", header = FALSE, 
					row.names = 1, stringsAsFactors = FALSE))
					
pcg_path_name="/mnt/5468d/gaomeihong/LncRNA3/GAE_LGA/Datasets/Dataset3/pcg_name.txt"
